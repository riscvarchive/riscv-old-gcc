...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  /* TLS relocations.  */
  RELOC_NUMBER (R_RISCV_TPREL_HI20, 30)
  RELOC_NUMBER (R_RISCV_TPREL_LO12_I, 31)
  RELOC_NUMBER (R_RISCV_TPREL_LO12_S, 32)
...
#define E_RISCV_EXT_Xhalf   0x0002
