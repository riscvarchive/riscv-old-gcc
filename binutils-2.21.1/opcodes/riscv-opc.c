...
{"fmv.x.s",   "d,S",	MATCH_FMV_X_S, MASK_FMV_X_S,  WR_xd|RD_fs1 },
{"fmv.s.x",   "D,s",	MATCH_FMV_S_X, MASK_FMV_S_X,  WR_fd|RD_xs1 },
{"fmv.x.d",   "d,S",	MATCH_FMV_X_D, MASK_FMV_X_D,  WR_xd|RD_fs1 },
{"fmv.d.x",   "D,s",	MATCH_FMV_D_X, MASK_FMV_D_X,  WR_fd|RD_xs1 },
{"fmv.s",   "D,S",	0,    (int) M_FMV_S, INSN_MACRO }, /* fsgnj.s */
{"fmv.d",   "D,S",	0,    (int) M_FMV_D, INSN_MACRO }, /* fsgnj.d */
...
{"ret",      "",	MATCH_JALR | (LINK_REG << OP_SH_RS), MASK_JALR | MASK_RD | MASK_RS | MASK_IMM,	 WR_xd|RD_xs1 },
{"jal",     "a",	MATCH_JAL, MASK_JAL,	 WR_ra },
{"j",       "a",	MATCH_J, MASK_J,	 0 },
{"jr",      "s",	MATCH_JALR, MASK_JALR | MASK_RD | MASK_IMM,	 WR_xd|RD_xs1 },
{"jr",      "s,j",	MATCH_JALR, MASK_JALR | MASK_RD,	 WR_xd|RD_xs1 },
{"jalr",    "s",	MATCH_JALR | (LINK_REG << OP_SH_RD), MASK_JALR | MASK_RD | MASK_IMM,	 WR_xd|RD_xs1 },
{"jalr",    "s,j",	MATCH_JALR | (LINK_REG << OP_SH_RD), MASK_JALR | MASK_RD,	 WR_xd|RD_xs1 },
{"jalr",    "d,s",	MATCH_JALR, MASK_JALR | MASK_IMM,	 WR_xd|RD_xs1 },
{"jalr",    "d,s,j",	MATCH_JALR, MASK_JALR,	 WR_xd|RD_xs1 },
